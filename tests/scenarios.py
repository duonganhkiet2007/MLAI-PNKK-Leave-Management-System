...
case(9,'Friday–Monday',{'from_date':'2026-10-09','to_date':'2026-10-12'},deduct=2),
case(10,'Chỉ weekend',{'from_date':'2026-10-10','to_date':'2026-10-11'},'NO_LEAVE_REQUIRED',days=0,error='DAY_ALREADY_NON_WORKING'),
case(11,'Self marriage',{'leave_type':'SPECIAL_PAID','reason_category':'SELF_MARRIAGE','to_date':'2026-10-07','proof':{**PROOF,'proof_type':'MARRIAGE_CERTIFICATE'}},days=3,harness=True),
case(12,'Child marriage',{'leave_type':'SPECIAL_PAID','reason_category':'CHILD_MARRIAGE','to_date':'2026-10-05','proof':{**PROOF,'proof_type':'WEDDING_INVITATION'}},days=1),
case(13,'Parent death',{'leave_type':'SPECIAL_PAID','reason_category':'PARENT_DEATH','to_date':'2026-10-07','proof':{**PROOF,'proof_type':'DEATH_CERTIFICATE'}},days=3),
case(14,'Grandparent death',{'leave_type':'STATUTORY_UNPAID','reason_category':'GRANDPARENT_DEATH','to_date':'2026-10-05'},days=1,harness=True),
case(15,'Sick valid proof',{'leave_type':'SICK_MEDICAL','proof':PROOF}),
case(16,'Sick missing proof',{'leave_type':'SICK_MEDICAL'},'NEED_CORRECTION','EMPLOYEE',cat=C,error='PROOF_MISSING'),
case(17,'Unreadable proof',{'leave_type':'SICK_MEDICAL','proof':{**PROOF,'document_readability':'ILLEGIBLE'}},'NEED_CORRECTION','EMPLOYEE',cat=C,error='DOC_ILLEGIBLE'),
...
case(27,'Annual chán đi làm',{'reason':'Em nghỉ 2 ngày vì chán đi làm.'},deduct=2),
